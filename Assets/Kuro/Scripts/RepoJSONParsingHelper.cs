...
/// <summary>
/// Enables parsing the raw Repo JSON without importing Newtonsoft.Json
/// </summary>
public static class RepoJSONParser
{
    /// <summary>
    /// Parses the JSON provided by <see href="https://ktane.timwi.de/json/raw"/> into an operable object.
    /// </summary>
    public static List<KtaneModule> ParseRaw(string raw)
    {
        return JsonConvert.DeserializeObject<Root>(raw).KtaneModules;
    }
}
